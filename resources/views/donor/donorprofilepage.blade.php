        ...
        <div class="mt-8 p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
            <div class="flex flex-wrap gap-6 items-center">
                ...
                <div class="relative shrink-0 h-40 w-40 rounded-full overflow-hidden border-2 border-gray-300 cursor-pointer group">
                    ...
                    @else
                        <div class="h-full w-full flex items-center justify-center bg-blue-500 text-white text-5xl font-bold">
                            {{ strtoupper(substr(Auth::user()->firstname ?? Auth::user()->name ?? 'D', 0, 1)) }}
                        </div>
                    @endif
                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 flex items-center justify-center text-white font-semibold text-sm transition-opacity duration-300">
            ...
            @else
                <div class="space-y-4">
                    @foreach($donations as $donation)
                        <div class="p-6 bg-gray-50 border border-gray-200 rounded-lg shadow-sm flex justify-between items-start">
                            <!-- Campaign Details -->
                            <div class="flex-1">
