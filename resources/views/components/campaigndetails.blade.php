                    ...
                    <div class="w-full ml-5 p-5 bg-white border border-gray-200 rounded-lg shadow-sm">
                        ...
                        <div class="border-t mt-5 border-gray-300">
                            <div class="flex items-center gap-2 mt-3">
                                ...
                                <div>
                                    <h1 class="text-xl">
                                        {{ \Carbon\Carbon::parse($campaign->end_date)->diffInDays(now()) }} Days Left
                                    </h1>
                                    <h1 class="text-gray-500">
                                        Started {{ \Carbon\Carbon::parse($campaign->start_date)->format('M d, Y') }}
                                    </h1>
                                </div>
                            </div>
                        </div>
        ...
        <div class="flex">
            ...
            <div class="w-1/2">
                <div class="flex-col justify-center">
                    ...
                    <div class="w-full ml-5 p-5 bg-white border border-gray-200 rounded-lg shadow-sm">
                        <h5 class="mb-2 text-2xl flex font-bold tracking-tight text-gray-900 dark:text-white">
                            Target: ${{ number_format($campaign->goal_amount ?? 0, 2) }}
                        </h5>
                        ...
                        <!-- Placeholder for future donation button -->
                        <div class="mt-5">
                            <button type="button"
                                class="flex justify-center items-center gap-2 w-full text-white bg-gray-400 cursor-not-allowed font-medium rounded-lg text-sm px-5 py-2.5">
                                <span><x-icons.haticon /></span>
