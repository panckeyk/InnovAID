            ...
            <table class="w-full text-sm text-left text-gray-600">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" id="category" class="px-6 py-3 text-center w-[10%]">Category</th>
                        <th scope="col" id="goal" class="px-6 py-3 text-center w-[10%]">Goal</th>
                        <th scope="col" id="submitted" class="px-6 py-3 text-center w-[15%]">Submitted</th>
                ...
                <tbody>
                    <tr class="bg-white border-b border-b-gray-200 hover:bg-gray-100">
                        ...
                        <!-- Submitted -->
                        <td headers="submitted" class="px-6 py-3 text-center text-gray-500">10/20/2024</td>
                        ...
                        <td headers="actions" class="px-6 py-3 text-center">
                            <div class="flex justify-center items-center gap-2">
                                ...
                                <!-- Approve -->
                                <button class="p-1 text-white rounded-full hover:bg-green-200 transition"
                                    title="Approve">
                                    <x-icons.checkicon/>
                                </button>

                                <!-- Reject -->
                                <button class="p-1  text-white rounded-full hover:bg-red-200 transition"
                                    title="Reject">
                                    <x-icons.closeicon/>
                                </button>
                            </div>
